...
有興趣的項目:
<br>
籃球<input type="checkbox" name="mInterest" value="basketball"><br>
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRiSsl9eMEorv6Am2Alclqi5CAncdaeh7yUw&s"></img><br>
棒球<input type="checkbox" name="mInterest" value="baseball"><br>
...
羽球<input type="checkbox" name="mInterest" value="badminton"><br>
<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRTgL1Oq1Xj4R2F4gId8S4wSUCcwTdGMNdniQ&s"></img><br>
年紀:
<input type="number" name="mNumber" value="m" min="1" max="100"><br>
Email:
<input type="email" name="mEmail" value="xxxxx@gmail.com"><br>
